...
css_replacement = """  <style>
    ...
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .floating-github {
      ...
      border-radius:50%; background:rgba(15,23,42,0.65);
...
html_files = ['drones.html', 'breast_cancer.html', 'grey_wolf.html', 'zero_trust_system.html']

for root_dir in [r'd:\Portfolio', r'd:\Portfolio\vite-app\public']:
  for fname in html_files:
    ...
    if os.path.exists(path):
        ...
        new_content = re.sub(r'<style>[\s\S]*?</style>', css_replacement, content)
